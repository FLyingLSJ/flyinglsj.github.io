...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.button_status() # 最开始设置只要连接按钮可以操作
        self.show()
    ...
    def connect_showMessage(self):
        ...
        while connect_flage:
            ...
            try:
                ...
                self.connect_button.setEnabled((False))  # 连接成功后按键变为灰色：即不可再操作
    ...
    def close_showMessage(self):
        ...
        self.text.setFocus()
        self.button_status(True, False, False)
        ...
        while self.register_flag:
            try:
                ...
                if bool(RegResult['success']):
                    ...
                    self.button_status(False, True, False)
                    self.text.setFocus()
                    break
            except Exception as e:
